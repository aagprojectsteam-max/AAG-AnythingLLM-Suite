...
const { aagArtifactExportEndpoints } = require("./endpoints/aagArtifactExport");
const { aagComposerProxyEndpoints } = require("./endpoints/aagComposerProxy");
...
aagArtifactExportEndpoints(apiRouter);
aagComposerProxyEndpoints(apiRouter);
