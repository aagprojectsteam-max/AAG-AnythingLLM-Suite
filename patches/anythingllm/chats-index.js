...
const { executeAagLocalImageCommand } = require("./commands/aagIdentity");
const { executeAagOrdinaryCommand } = require("./commands/aagOrdinary");
...
const VALID_COMMANDS = {
  "/reset": resetMemory,
  "/img": generateImage,
  "/aag-identity": executeAagLocalImageCommand,
  "/aag-image": executeAagLocalImageCommand,
  "/aag-generate": executeAagOrdinaryCommand,
};
